...
"Copiado para a area de<br>transferência."),b.i18n("buttons.copySuccess",{1:"Copiar uma linha",_:"Copiado %d linhas para area de transferência"},a.rows),2E3);return}}catch(h){}}e=g("<span>"+b.i18n("buttons.copyKeys","Tecle <i>ctrl</i> ou <i>⌘</i> + <i>C</i> copiar os registros<br>para a area de transferência.<br><br>, Click para cancelar ou pressione esc.")+"</span>").append(d);b.buttons.info(b.i18n("buttons.copyTitle","Copy to clipboard"),e,0);c[0].focus();c[0].select();var l=g(e).closest(".dt-button-info"),i=function(){l.off("click.buttons-copy");
